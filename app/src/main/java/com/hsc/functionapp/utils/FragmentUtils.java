...
public final class FragmentUtils {
    ...
    /**
     * 查找fragment,存在则show，不存在则add
     *
     * @param fragmentManager fragment管理器
     * @param fragment   fragment
     * @param layoutId   要加入的id
     */
    public static void findFragmentAddorShow(@NonNull FragmentManager fragmentManager, Fragment fragment,int layoutId) {
        List<Fragment> fragments = getFragments(fragmentManager);
        if (fragments.isEmpty()){
            addFragment(fragmentManager,fragment,layoutId);
        }else{
    ...
    /**
     * 查找同级fragment,存在的hide,不存在则不需要做处理
     * @param fragmentManager fragment管理器
     * @param fragment   fragment
     */
    public static void findFragmentHide(@NonNull FragmentManager fragmentManager, Fragment fragment) {
        List<Fragment> fragments = getFragments(fragmentManager);
        if (!fragments.isEmpty()) {
